...
taskerRouter.get("/api/v1/get-my-default-location", TaskerController.handleGetMyDefaultLocation);
...
taskerRouter.get("/api/v1/get-my-task-history", TaskerController.handleGetMyTaskHistory);
