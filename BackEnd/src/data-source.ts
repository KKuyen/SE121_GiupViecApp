...
export const AppDataSource = new DataSource({
  ...
  migrations: [
    ...
    CreateMessageReviewTable1634567890123,
    TaskerInfoMigration1698321400516,
    AddPriceDetailsMigration1698324600523,
    AddPricesMigration1698324600525,
    BlockTaskersMigration1698322600520,
    LoveTaskersMigration1698322600519,
    MyVouchersMigration1698324600531,
    NotificationsMigration1698324600529,
    ReviewsMigration1698324600528,
    TaskerListMigration1698324600527,
    TaskTypesMigration1698324600522,
    LocationsMigration1698321600518,
    ReTasksMigration1698324600526,
    UserSettingsMigration1698323600521,
    TasksMigration1698324600524,
    VouchersMigration1698324600530,
  ],
  subscribers: [],
});
